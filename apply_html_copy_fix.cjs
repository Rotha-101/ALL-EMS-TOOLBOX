...
const targetRegex = /async function copyGraphsToClipboard\(\) \{[\s\S]*?(?=function resetAllConfig\(\))/m;

const replacement = `async function copyGraphsToClipboard() {
...
console.log('Fixed copyGraphsToClipboard safely!');
